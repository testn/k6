...
func TestOldArchive(t *testing.T) {
	var testCases = map[string]string{
		...
		"go.staging.k6.io/k6/samples/example.js": `github file`,
	...
	for filename, data := range testCases {
		...
		t.Run(filename, func(t *testing.T) {
			...
			fs := makeMemMapFs(t, map[string][]byte{
				// files
				"/files/go.staging.k6.io/k6/samples/example.js": []byte(`github file`),
				...
				// scripts
				"/scripts/go.staging.k6.io/k6/samples/example.js2": []byte(`github script`),
			...
			var (
				expectedFilesystems = map[string]afero.Fs{
					...
					"https": makeMemMapFs(t, map[string][]byte{
						...
						"/go.staging.k6.io/k6/samples/example.js":  []byte(`github file`),
						"/cdnjs.com/packages/Faker":                     []byte(`faker file`),
						"/go.staging.k6.io/k6/samples/example.js2": []byte(`github script`),
...
func TestFilenamePwdResolve(t *testing.T) {
	var tests = []struct {
		...
		{
			Filename:            "go.staging.k6.io/k6/samples/http2.js",
			Pwd:                 "go.staging.k6.io/k6/samples",
			expectedFilenameURL: &url.URL{Opaque: "go.staging.k6.io/k6/samples/http2.js"},
			expectedPwdURL:      &url.URL{Opaque: "go.staging.k6.io/k6/samples"},
		},
		{
